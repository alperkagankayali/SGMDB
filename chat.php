    ...
    <div class="w3-col m7">
      ...
      <?php
          for($i = 0; $i < $counter; $i++)
          {
              ...
              echo "<div class=\"w3-container w3-card w3-round w3-margin\"><br>";
              echo "<img src=";
              ...
              echo "</h4><br>";
              echo "<a href=\"chat_with_player.php?send_id=" .$player_id2. "\"class=\"w3-button w3-block w3-theme-l1 w3-left-align\">Go to chat ></a>";
              echo "<hr class=\"w3-clear\"> </div>";
            }
