<?php
    ...
    if(isset($_GET['category']))
    {
        ...
        {
            // Query for accessing all the games with the given category in the cart
            $access_cart = "SELECT C.game_name FROM game as G NATURAL JOIN cart as C
                               WHERE G.game_category = '$category' AND C.player_id = $player_id";
        }
        else
        {
            // Query for accessing all free games in the cart
            $access_cart = "SELECT C.game_name FROM game as G NATURAL JOIN cart as C
                               WHERE G.game_price = 0 AND C.player_id = $player_id";
        }
    }
    else if(!isset($_GET['category']) && isset($_GET['platform']))
    {
        ...
        $access_cart = "SELECT C.game_name FROM game as G NATURAL JOIN cart as C
                           WHERE G.platform LIKE '%$platform%' AND C.player_id = $player_id";
    }
    else
    {
    ...
    <div class="w3-row">
      ...
      <div class="w3-col m3">
        ...
        <div class="w3-card w3-round white-font">
            <div>
                <a href="cart.php?category=Free to play" class="w3-button w3-block w3-theme-l1 w3-left-align"> Free to Play</a>
                <a href="cart.php?category=Action" class="w3-button w3-block w3-theme-l1 w3-left-align"> Action</a>
                <a href="cart.php?category=Adventure" class="w3-button w3-block w3-theme-l1 w3-left-align"> Adventure</a>
                <a href="cart.php?category=Casual" class="w3-button w3-block w3-theme-l1 w3-left-align"> Casual</a>
                <a href="cart.php?category=Indie" class="w3-button w3-block w3-theme-l1 w3-left-align"> Indie</a>
                <a href="cart.php?category=Multiplayer" class="w3-button w3-block w3-theme-l1 w3-left-align"> Multiplayer</a>
                <a href="cart.php?category=Racing" class="w3-button w3-block w3-theme-l1 w3-left-align"> Racing</a>
                <a href="cart.php?category=RPG" class="w3-button w3-block w3-theme-l1 w3-left-align"> RPG</a>
                <a href="cart.php?category=Simulation" class="w3-button w3-block w3-theme-l1 w3-left-align"> Simulation</a>
                <a href="cart.php?category=Sports" class="w3-button w3-block w3-theme-l1 w3-left-align"> Sports</a>
                <a href="cart.php?category=Strategy" class="w3-button w3-block w3-theme-l1 w3-left-align"> Strategy</a>
            </div>
        </div>
        ...
        <div class="w3-card w3-round white-font">
            <div>
                <a href="cart.php?platform=Windows" class="w3-button w3-block w3-theme-l1 w3-left-align"> Windows</a>
                <a href="cart.php?platform=Mac" class="w3-button w3-block w3-theme-l1 w3-left-align"> MacOS</a>
                <a href="cart.php?platform=Linux" class="w3-button w3-block w3-theme-l1 w3-left-align"> Linux</a>
            </div>
        </div>
