...
<div class="w3-content white-font" style="max-width:1100px;margin-top:80px;margin-bottom:80px">
    <div class="w3-panel">
    <h1><br>Friends do not have <?php echo "<i><u>'".$game_name."'</u></i>"; ?></h1>
    </div>
    ...
    <div class="w3-col m7">
      ...
      ?>
        <div class="w3-container w3-card w3-round w3-margin"><br>
          ...
          <hr class="w3-clear">
          <a href="process_buying_gift.php?game_name=<?php echo $game_name; ?>&game_price=<?php echo $game_price; ?>&receiver_id=<?php echo $player_id2; ?>" class="w3-button w3-block w3-theme-l1 w3-left-align">Send Gift ></a>
        </div>
